...
RECALL="Before answering this prompt: call the context MCP select() with a query built from the intent of the prompt, k=6, and treat the results as project ground truth."
